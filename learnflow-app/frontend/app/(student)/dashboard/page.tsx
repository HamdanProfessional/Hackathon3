...
const Icons = {
  ...
  Star: (
    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.981-1.81a1 1 0 00-.81-1.223l-1.518-4.674a1 1 0 00-1.78 0l-3.976-2.888a1 1 0 00-.363-1.118l1.518-4.674z" />
    </svg>
  ),
  Code: (
    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
