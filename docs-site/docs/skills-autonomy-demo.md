...
| End-to-end deployment |  | Requires container registry |
...
agents-md-gen                  ~239       
kafka-k8s-setup                ~146       
postgres-k8s-setup             ~234       
fastapi-dapr-agent             ~155       
mcp-code-execution             ~157       
nextjs-k8s-deploy              ~228       
docusaurus-deploy              ~224       
k8s-foundation                 ~220       
skill-registry                 ~205       
test-skill                     ~173       
