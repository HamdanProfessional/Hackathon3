...
3.  Test event publishing - YAML issues on Windows (works on Linux/Mac)
4.  Add GLM API key for LLM integration
5.  Deploy kafka-direct.yaml (needs testing)
...
| **Test Scripts** |  Partial | YAML issues on Windows (works on Linux) |
